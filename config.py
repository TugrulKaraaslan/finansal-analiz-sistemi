...
TA_STRATEGY = ta.Strategy(
    ...
    ta=[
        ...
        },
        {
            ...
            "lower_length": 20,
            "upper_length": 20,
            "col_names": ("dcl_20_20", "dcm_20_20", "dcu_20_20"),
        },
        {
            "kind": "kc",
            "length": 20,
            "scalar": 2,
            "col_names": ("kcl_20_2", "kcm_20_2", "kcu_20_2"),
        },
        ...
        {"kind": "mom", "length": 10, "col_names": ("momentum_10",)},
        {
            ...
            "slow": 26,
            "signal": 9,
            "col_names": ("ppo_line", "ppo_signal", "ppo_hist"),
        },
        ...
        {"kind": "adx", "length": 14, "col_names": ("adx_14", "DMP_14", "DMN_14")},
        {
            ...
            "senkou": 52,
            "include_chikou": True,
            "col_names": ("ITS_9", "IKS_26", "ISA_9_26_52", "ISB_26_52", "ICS_26"),
        },
        {
            "kind": "psar",
            "col_names": ("psar_long", "psar_short", "psar_af", "psar_reversal"),
        },
        {
            "kind": "supertrend",
            "length": 7,
            "multiplier": 3,
            "col_names": (
                "supertrend_direction_7_3",
                "supertrend_7_3",
                "supertrend_long_7_3",
                "supertrend_short_7_3",
            ),
        },  # Düzeltildi
        {"kind": "vortex", "length": 14, "col_names": ("vortex_pos", "vortex_neg")},
        {
            "kind": "aroon",
            "length": 14,
            "col_names": ("AROOND_14", "AROONU_14", "AROONOSC_14"),
        },
...
INDIKATOR_AD_ESLESTIRME = {
    ...
    "stochrsi_d_14_14_3_3": "stochrsi_d",
    "cci_20_0.015": "cci_20",
    "ppoh_12_26_9": "ppo_hist",
    "ppos_12_26_9": "ppo_signal",
    "ppo_12_26_9": "ppo_line",
    "psarl_0.02_0.2": "psar_long",
    "psars_0.02_0.2": "psar_short",
    "psaraf_0.02_0.2": "psar_af",
    "psarr_0.02_0.2": "psar_reversal",
...
OZEL_SUTUN_PARAMS = [
    {
        ...
        "function": "_calculate_relative_volume",
        "params": {"window": 20, "col_name_prefix": "volume"},
    },
    {
        "name": "volume_price",
        "function": "_calculate_volume_price",
        "params": {"col_name_prefix_vol": "volume", "col_name_prefix_price": "close"},
    },
    {
        "name": "change_from_open_percent",
        "function": "_calculate_change_from_open",
        "params": {"col_name_open": "open", "col_name_close": "close"},
    },
    {
        "name": "percentage_from_ath",
        "function": "_calculate_percentage_from_all_time_high",
        "params": {"price_col": "high"},
    },
    {
        "name": "change_1w_percent",
        "function": "_calculate_change_percent",
        "params": {
            "period": 5,
            "price_col": "close",
            "output_col_name": "change_1w_percent",
        },
    },
    {
        ...
        "params": {
            "period": 20,
            "price_col": "close",
            "output_col_name": "change_1m_percent",
        },
    },
    {
        ...
        "params": {
            "period": 1,
            "price_col": "close",
            "output_col_name": "change_1h_percent",
        },
    },
    {
        "name": "volume_20_sma",
        "function": "_calculate_sma",
        "params": {"period": 20, "data_col": "volume"},
    },
    {
        "name": "prev_high_1",
        "function": "_get_previous_bar_value",
        "params": {"data_col": "high", "shift_by": 1},
    },
    {
        "name": "prev_low_1",
        "function": "_get_previous_bar_value",
        "params": {"data_col": "low", "shift_by": 1},
    },
    {"name": "psar", "function": "_calculate_combined_psar", "params": {}},
    {
        "name": "percentage_from_52w_high",
        "function": "_calculate_percentage_from_period_high_low",
        "params": {"price_col": "high", "period": 252, "mode": "high"},
    },
    {
        "name": "percentage_from_52w_low",
        "function": "_calculate_percentage_from_period_high_low",
        "params": {"price_col": "low", "period": 252, "mode": "low"},
    },
    {
        "name": "volume_change_percent_1d",
        "function": "_calculate_change_percent",
        "params": {
            "period": 1,
            "price_col": "volume",
            "output_col_name": "volume_change_percent_1d",
        },
    },
    {
        "name": "classicpivots_1h_p",
        "function": "_calculate_classicpivots_1h_p",
        "params": {},
    },
]
...
SERIES_VALUE_CROSSOVERS = [
    ...
    ("adx_14", 25.0, "25p0"),
    ("adx_14", 30.0, "30p0"),
    ("williamspercentr_14", -80.0, "eksi80p0"),
    ("williamspercentr_14", -50.0, "eksi50p0"),
    ("williamspercentr_14", -20.0, "eksi20p0"),
    ("macd_line", 0.0, "0p0"),
    ("stoch_k", 20.0, "20p0"),
    ("stoch_k", 80.0, "80p0"),
    ("stoch_d", 20.0, "20p0"),
    ("stoch_d", 80.0, "80p0"),
    ("stochrsi_k", 20.0, "20p0"),
    ("stochrsi_k", 80.0, "80p0"),
    ("stochrsi_d", 20.0, "20p0"),
    ("stochrsi_d", 80.0, "80p0"),
    ("cmf_20", 0.0, "0p0"),
    ("cmf_20", 0.2, "0p2"),
    ("cmf_20", -0.2, "eksi0p2"),
    ("cci_20", 100.0, "100p0"),
    ("cci_20", -100.0, "eksi100p0"),
    ("cci_20", 0.0, "0p0"),
    ("momentum_10", 0.0, "0p0"),
    ("momentum_10", 1.0, "1p0"),
    ("mfi_14", 20.0, "20p0"),
