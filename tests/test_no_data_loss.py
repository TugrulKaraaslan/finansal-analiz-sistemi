...
def test_no_data_loss(tmp_path):
    ...
    df_sum = pd.DataFrame([{
        "filtre_kodu":"T1","hisse_sayisi":None,"ort_getiri_%":None,
        "en_yuksek_%":None,"en_dusuk_%":None,"islemli":0,
        "sebep_kodu":"NO_STOCK","sebep_aciklama":"","tarama_tarihi":"","satis_tarihi":""
    }])
    df_det = pd.DataFrame()
